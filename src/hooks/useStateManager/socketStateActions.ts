import type { SocketActions, SocketStateDispatchType } from "@customTypes/socket";
...
export const createSocketActions = (dispatch: Dispatch<ReducerActionPayload>):SocketActions => {
  const connect = () => {
